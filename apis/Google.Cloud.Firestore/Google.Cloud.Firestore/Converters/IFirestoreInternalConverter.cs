...
namespace Google.Cloud.Firestore.Converters
{
    ...
    internal interface IFirestoreInternalConverter
    {
        ...
        /// </summary>
        /// <param name="serializationContext">Serialization context to use when serializing the value</param>
        ...
        void SerializeMap(SerializationContext serializationContext, object value, IDictionary<string, Value> map);
    }
}
