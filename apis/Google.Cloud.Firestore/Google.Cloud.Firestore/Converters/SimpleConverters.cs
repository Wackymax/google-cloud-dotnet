...
namespace Google.Cloud.Firestore.Converters
{
    ...
    internal sealed class StringConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { StringValue = (string) value };
    ...
    internal sealed class ByteConverter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (byte) value };
    ...
    internal sealed class SByteConverter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (sbyte) value };
    ...
    internal sealed class Int16Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (short) value };
    ...
    internal sealed class UInt16Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (ushort) value };
    ...
    internal sealed class Int32Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (int) value };
    ...
    internal sealed class UInt32Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (uint) value };
    ...
    internal sealed class Int64Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = (long) value };
    ...
    internal sealed class UInt64Converter : IntegerConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { IntegerValue = checked((long) (ulong) value) };
    ...
    internal sealed class SingleConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { DoubleValue = (float) value };
    ...
    internal sealed class DoubleConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { DoubleValue = (double) value };
    ...
    internal sealed class BooleanConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { BooleanValue = (bool) value };
    ...
    internal sealed class TimestampConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { TimestampValue = ((Timestamp) value).ToProto() };
    ...
    internal sealed class GeoPointConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { GeoPointValue = ((GeoPoint) value).ToProto() };
    ...
    internal sealed class ByteStringConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { BytesValue = (ByteString) value };
    ...
    internal sealed class ByteArrayConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { BytesValue = ByteString.CopyFrom((byte[]) value) };
    ...
    internal sealed class BlobConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { BytesValue = ((Blob) value).ByteString };
    ...
    internal sealed class SentinelValueConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => ((SentinelValue) value).ToProtoValue();
    }

    internal sealed class DateTimeConverter : ConverterBase
    {
        internal DateTimeConverter() : base(typeof(DateTime)) { }
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { TimestampValue = wkt::Timestamp.FromDateTime((DateTime) value) };
    ...
    internal sealed class DateTimeOffsetConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { TimestampValue = wkt::Timestamp.FromDateTimeOffset((DateTimeOffset) value) };
    ...
    internal sealed class TimestampProtoConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { TimestampValue = ((wkt::Timestamp) value).Clone() };
    ...
    internal sealed class ValueConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => ((Value) value).Clone();
    ...
    internal sealed class LatLngConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { GeoPointValue = ((LatLng) value).Clone() };
    ...
    internal sealed class DocumentReferenceConverter : ConverterBase
    {
        ...
        public override Value Serialize(SerializationContext serializationContext, object value) => new Value { ReferenceValue = ((DocumentReference) value).Path };
