...
namespace Google.Cloud.Firestore
{
    ...
    internal sealed class SentinelValue
    {
        ...
        internal static SentinelValue ForArrayValue(SerializationContext serializationContext, SentinelKind sentinelKind, object[] values)
        {
            GaxPreconditions.CheckNotNull(values, nameof(values));
            ArrayValue array = serializationContext.Serializer.Serialize(serializationContext, values).ArrayValue;
